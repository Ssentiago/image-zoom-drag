...
const Interactive: FC = () => {
    ...
    const [isIMOptionEnabled, setIsIMOptionEnabled] = useState(
        plugin.settings.data.diagrams.interactive.markdown.autoDetect
    );
    const [activationMode, setActivationMode] = useState(
        plugin.settings.data.diagrams.interactive.markdown.activationMode
    );
        ...
        <>
            ...
            <ReactObsidianSetting
                ...
                addToggles={[
                    (t) => {
                        t.setValue(
                            plugin.settings.data.diagrams.interactive.picker
                                .enabled
                        );
                        t.onChange(async (value) => {
                            plugin.settings.data.diagrams.interactive.picker.enabled =
                                value;
            ...
            <ReactObsidianSetting
                ...
                addToggles={[
                    (toggle) => {
                        toggle.setValue(
                            plugin.settings.data.diagrams.interactive.markdown
                                .autoDetect
                        );
                ...
                <ReactObsidianSetting
                    ...
                    addDropdowns={[
                        (dropdown) => {
                            ...
                            dropdown.setValue(
                                plugin.settings.data.diagrams.interactive
