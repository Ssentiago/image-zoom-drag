            ...
            images: {
                ...
                general: {
                    ...
                    size: {
                        ...
                        validation: {
                            ...
                            invalidHeight:
                                'Invalid height. Please enter number in range {{range}}.',
                            invalidWidth:
                                'Invalid width. Please enter number in range {{range}}.',
                ...
                presets: {
                    addNewImagePreset: {
                        ...
                        tooltips: {
                            infoButton:
                                'Click for more information on how the plugin works',
                    ...
                    availableImageConfigs: {
                        ...
                        pagination: {
                            buttons: {
                                editingBlocked:
                                    'Can`t change page while editing',
                                next: {
