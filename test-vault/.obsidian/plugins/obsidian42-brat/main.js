    ...
    'node_modules/obsidian-daily-notes-interface/dist/main.js'(exports) {
        ...
        function shouldUsePeriodicNotesSettings(periodicity) {
            ...
            return (
                periodicNotes &&
                ((_b =
                    (_a = periodicNotes.settings) == null
                        ? void 0
                        : _a[periodicity]) == null
                    ? void 0
                    : _b.enabled)
            ...
            try {
                ...
                if (shouldUsePeriodicNotesSettings('daily')) {
                    ...
                    return {
                        ...
                        folder:
                            (folder2 == null ? void 0 : folder2.trim()) || '',
                        template:
                            (template2 == null ? void 0 : template2.trim()) ||
                            '',
                    };
                }
                const { folder, format, template } =
                    ((_d =
                        (_c = internalPlugins.getPluginById('daily-notes')) ==
                        null
                            ? void 0
                            : _c.instance) == null
                        ? void 0
                ...
                return {
                    ...
                    template:
                        (template == null ? void 0 : template.trim()) || '',
                };
            } catch (err) {
        ...
        function getWeeklyNoteSettings() {
            ...
            try {
                ...
                return {
                    format:
                        settings.weeklyNoteFormat || DEFAULT_WEEKLY_NOTE_FORMAT,
                    folder:
                        ((_f = settings.weeklyNoteFolder) == null
                            ? void 0
                            : _f.trim()) || '',
                    template:
                        ((_g = settings.weeklyNoteTemplate) == null
                            ? void 0
                            : _g.trim()) || '',
                };
            } catch (err) {
            ...
            try {
                const settings =
                    (shouldUsePeriodicNotesSettings('monthly') &&
                        ((_b =
                            (_a = pluginManager.getPlugin('periodic-notes')) ==
                            null
                                ? void 0
                                : _a.settings) == null
                            ? void 0
                ...
                return {
                    ...
                    folder:
                        ((_c = settings.folder) == null ? void 0 : _c.trim()) ||
                        '',
                    template:
                        ((_d = settings.template) == null
                            ? void 0
                            : _d.trim()) || '',
                };
            } catch (err) {
        ...
        async function createDailyNote(date) {
            ...
            const [templateContents, IFoldInfo] =
                await getTemplateInfo(template);
        ...
        function getDailyNote(date, dailyNotes) {
            var _a;
            return (_a = dailyNotes[getDateUID(date, 'day')]) != null
                ? _a
                : null;
        }
                    ...
                    templateContents
                        ...
                        .replace(
                            ...
                            (_, dayOfWeek, momentFormat) => {
                                const day =
                                    getDayOfWeekNumericalValue(dayOfWeek);
                                return date
                                    .weekday(day)
        ...
        function getWeeklyNote(date, weeklyNotes) {
            var _a;
            return (_a = weeklyNotes[getDateUID(date, 'week')]) != null
                ? _a
                : null;
        }
        ...
        function getMonthlyNote(date, monthlyNotes) {
            var _a;
            return (_a = monthlyNotes[getDateUID(date, 'month')]) != null
                ? _a
                : null;
        }
        ...
        function getQuarterlyNote(date, quarterly) {
            var _a;
            return (_a = quarterly[getDateUID(date, 'quarter')]) != null
                ? _a
                : null;
        }
        ...
        function getYearlyNote(date, yearlyNotes) {
            var _a;
            return (_a = yearlyNotes[getDateUID(date, 'year')]) != null
                ? _a
                : null;
        }
        ...
        exports.appHasQuarterlyNotesPluginLoaded =
...
var grabReleaseFileFromRepository = async (
    repository,
    version,
    fileName,
    debugLogging = true,
    ...
    try {
        ...
        if (isPrivate) {
            ...
            const release = data.find(
                (release2) => release2.tag_name === version
            );
            if (!release) {
                return null;
            }
...
var grabManifestJsonFromRepository = async (
    repositoryPath,
    rootManifest = true,
    debugLogging = true,
    personalAccessToken = ''
...
var grabCommmunityThemeCssFile = async (
    repositoryPath,
    betaVersion = false,
    debugLogging
) => {
...
var grabCommmunityThemeManifestFile = async (
    repositoryPath,
    debugLogging = true
) => {
...
var grabChecksumOfThemeCssFile = async (
    repositoryPath,
    betaVersion,
    debugLogging
) => {
...
var grabLastCommitInfoForFile = async (
    repositoryPath,
    path,
    debugLogging = true
) => {
...
var grabLastCommitDateForFile = async (repositoryPath, path) => {
    ...
    if (
        test &&
        test.length > 0 &&
        ((_a = test[0].commit.committer) == null ? void 0 : _a.date)
    ) {
...
function toastMessage(plugin, msg, timeoutInSeconds = 10, contextMenuCallback) {
    ...
    const additionalInfo = contextMenuCallback
        ? import_obsidian2.Platform.isDesktop
...
var themeSave = async (plugin, cssGithubRepository, newInstall) => {
    ...
    const themeTargetFolderPath = (0, import_obsidian3.normalizePath)(
    ...
    await adapter.write(
        (0, import_obsidian3.normalizePath)(
            themeTargetFolderPath + '/theme.css'
        ),
        themeCss
    );
    await adapter.write(
        (0, import_obsidian3.normalizePath)(
            themeTargetFolderPath + '/manifest.json'
        ),
        themeManifest
    );
...
var themesCheckAndUpdates = async (plugin, showInfo) => {
    ...
    if (showInfo && plugin.settings.notificationsEnabled)
        newNotice = new import_obsidian3.Notice(
            `BRAT
${msg1}`,
            3e4
        );
...
var themesRootPath = (plugin) => {
    return (
        (0, import_obsidian3.normalizePath)(
            plugin.app.vault.configDir + '/themes'
        ) + '/'
    );
};
...
var AddNewTheme = class extends import_obsidian4.Modal {
    ...
    onOpen() {
        ...
        this.contentEl.createEl('form', {}, (formEl) => {
            ...
            window.setTimeout(() => {
                const title = formEl.querySelectorAll(
                    '.brat-modal .setting-item-info'
                );
                ...
                .addButton((btn) => {
                    ...
                    btn.onClick(() => {
                        if (btn.buttonEl.textContent === '')
                            btn.setButtonText(
                                'Click once more to confirm removal'
                            );
                        else {
                            const { buttonEl } = btn;
        ...
        new import_obsidian5.Setting(containerEl)
            ...
            .addText((text) => {
                ...
                text.setPlaceholder('Enter your personal access token')
                    .setValue(
                        (_a = this.plugin.settings.personalAccessToken) != null
                            ? _a
                            : ''
                    )
...
The version attribute for the release is missing from the manifest file`,
    ...
    async writeReleaseFilesToPluginFolder(betaPluginId, relFiles) {
        ...
        const pluginTargetFolderPath =
            (0, import_obsidian7.normalizePath)(
...
The manifest${usingBetaManifest ? '-beta' : ''}.json file in the root directory of the repository does not have a version number in the file. This plugin cannot be installed.`;
        ...
        if (!Object.hasOwn(primaryManifest, 'minAppVersion')) {
            if (
                !(0, import_obsidian7.requireApiVersion)(
                    primaryManifest.minAppVersion
                )
            ) {
...
The release is not complete and cannot be download. main.js is missing from the Release`;
        ...
        if (!updatePluginFiles || forceReinstall) {
            ...
            if (enableAfterInstall) {
                ...
                const pluginTargetFolderPath = (0,
                import_obsidian7.normalizePath)(
...
Update of plugin failed.`
    ...
    async checkForPluginUpdatesAndInstallUpdates(
        ...
        if (showInfo && this.plugin.settings.notificationsEnabled)
            newNotice = new import_obsidian7.Notice(
                `BRAT
${msg1}`,
                3e4
            );
    ...
    deletePlugin(repositoryPath) {
        ...
        this.plugin.settings.pluginList =
            this.plugin.settings.pluginList.filter((b) => b !== repositoryPath);
        this.plugin.settings.pluginSubListFrozenVersion =
...
async function logger(plugin, textToLog, verboseLoggingOn = false) {
    ...
    if (plugin.settings.loggingEnabled) {
        if (!plugin.settings.loggingVerboseEnabled && verboseLoggingOn) {
            ...
            const dateOutput =
                '[[' +
                (0, import_obsidian9.moment)()
                    .format(
                        (0,
                        import_obsidian_daily_notes_interface.getDailyNoteSettings)()
                            .format
                    )
                    .toString() +
                ']] ' +
                (0, import_obsidian9.moment)().format('HH:mm');
            const os = window.require('os');
            const machineName = import_obsidian9.Platform.isDesktop
                ? os.hostname()
                : 'MOBILE';
            let output =
                dateOutput +
            ...
            if (await plugin.app.vault.adapter.exists(fileName)) {
                const fileContents =
                    await plugin.app.vault.adapter.read(fileName);
...
var GenericFuzzySuggester = class extends import_obsidian10.FuzzySuggestModal {
    ...
    enterTrigger(evt) {
        var _a;
        const selectedText =
            (_a = document.querySelector('.suggestion-item.is-selected div')) ==
            null
                ? void 0
                : _a.textContent;
...
Plugin reloading .....`,
            ...
            },
            {
                ...
                callback: () => {
                    ...
                    gfs.display((results) => {
                        void this.plugin.log(
                            `${results.display} plugin enabled`,
                            false
                        );
            ...
            },
            {
                ...
                callback: async () => {
                    ...
                    if (communityTheme) {
                        const communityThemeList = Object.values(
                            communityTheme
                        ).map((p) => {
                            return {
                                display: `Theme: ${p.name}  (${p.repo})`,
                                info: p.repo,
                            };
                        });
                        const gfs = new GenericFuzzySuggester(this.plugin);
    ...
    ribbonDisplayCommands() {
        ...
        const gfs = new GenericFuzzySuggester(this.plugin);
        const settings = this.plugin.app.setting;
        const listOfCoreSettingsTabs = Object.values(settings.settingTabs).map(
            (t) => {
                return {
                    display: 'Core: ' + t.name,
                    info: () => {
        ...
        const listOfPluginSettingsTabs = Object.values(settings.pluginTabs).map(
            (t) => {
                return {
